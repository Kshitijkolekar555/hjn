...
Render supports both backend and frontend deployment seamlessly.
...
4. **Deploy**: Render will build and deploy your backend automatically
...
3. **Deploy**: Render will build and deploy your frontend

#### Post-Deployment

- Update your frontend's `VITE_API_BASE_URL` to point to the deployed backend
- Ensure CORS is configured correctly in your backend for the frontend domain
